...
import i18n from '../../../Settings/Language/i18n'


import styles from './ChatWindow.module.css'
import Message from '../../Message/Message/Message'
import ChatDisconnection from '../ChatDisconnection/ChatDisconnection'
import EmptyChat from '../EmptyChat/EmptyChat'
import Attachment from '../Attachment/Attachment'
import BottomBar from '../BottomBar/BottomBar'
import { ContextMain } from '../../../../pages/Chats/contextMain'
import localReducer from './localReducer'
import { initWebSocket, getWebSocket, socketOnMessage, socketOnClose, socketOnError, disconnect, fullDeletingChat } from '../../../../WebSocket/webSocket'
import { modelMessage } from '../../../../WebSocket/Models'
import { setArrayMessages, removeMessage } from '../../../../store/messagesReducer'
import { setCompanion, resetCompanion, setChatId } from '../../../../store/companionReducer'
import { changeSocket } from '../../../../store/authReducer'
import { getChats } from '../../../../http/chatsApi'
